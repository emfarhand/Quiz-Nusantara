 ...
 * @author Asus
 */
public class L4_Question5 extends javax.swing.JFrame {
    int correct=0 ;
    /**
     * Creates new form Question1
     */
    public L4_Question5(int correct) {
        initComponents();
    ...
    private void initComponents() {
        ...
        pnl_q1.add(rbtn_ans1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 180, 120, -1));

        buttonGroup1.add(rbtn_ans2);
        rbtn_ans2.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans2.setText("Samudra Pasai");
        ...
        rbtn_ans3.setText("Holing");
        pnl_q1.add(rbtn_ans3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 180, 110, -1));

        buttonGroup1.add(rbtn_ans4);
        rbtn_ans4.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans4.setText("Tarumanegara");
        pnl_q1.add(rbtn_ans4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 220, -1, -1));
        ...
        pnl_q1.add(btn_next, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 260, -1, -1));
        ...
        jTextArea1.setText("Berikut ini yang termasuk kerajaan bercorak budhha yaitu\nKerajaan ...");
        jScrollPane1.setViewportView(jTextArea1);

        pnl_q1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 78, 376, 70));
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
       if(!rbtn_ans1.isSelected() && !rbtn_ans3.isSelected() && !rbtn_ans2.isSelected() && !rbtn_ans4.isSelected()){
        ...
        new Result(correct,4).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans3.isSelected()) {
        new Result(correct,4).setVisible(true);
        this.dispose();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L4_Question5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L4_Question5(0).setVisible(true);
            }
        });
    }
