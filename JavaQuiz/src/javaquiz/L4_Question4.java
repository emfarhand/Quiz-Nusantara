 ...
 * @author Asus
 */
public class L4_Question4 extends javax.swing.JFrame {
    int correct=0 ;
    /**
     * Creates new form Question1
     */
    public L4_Question4(int correct) {
        initComponents();
    ...
    private void initComponents() {
        ...
        pnl_q1.add(rbtn_ans1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 180, -1, -1));

        buttonGroup1.add(rbtn_ans2);
        rbtn_ans2.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans2.setText("4");
        pnl_q1.add(rbtn_ans2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 220, -1, -1));
        ...
        jTextArea1.setText("Kerajaan kalingga diperkirakan terletak di jawa tengah \ndi kecamatan keling sebelah utara gunung muria. Kerajaan \nini didirikan pada abad ke- ...");
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
        ...
        new L4_Question5(correct).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans3.isSelected()) {
        new L4_Question5(correct).setVisible(true);
        this.dispose();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L4_Question4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L4_Question4(0).setVisible(true);
            }
        });
    }
