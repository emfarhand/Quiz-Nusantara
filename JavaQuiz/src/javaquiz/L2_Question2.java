 ...
 * @author Asus
 */
public class L2_Question2 extends javax.swing.JFrame {
    int correct=0 ;
    /**
     * Creates new form Question1
     */
    public L2_Question2(int correct) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lbl_title.setText("LEVEL 2 :  Kehidupan Zaman Praaksara");
        ...
        rbtn_ans4.setText("Paleozoikum-Neozoikum-Mesozoikum-Archaeikum");
        rbtn_ans4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbtn_ans4ActionPerformed(evt);
            }
        });
        pnl_q1.add(rbtn_ans4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 240, -1, -1));
        ...
        pnl_q1.add(btn_next, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 270, -1, -1));

        rbtn_ans1.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans1.setText("Archaeikum-Paleozoikum-Mesozoikum-Neozoikum");
        rbtn_ans1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbtn_ans1ActionPerformed(evt);
            }
        });
        pnl_q1.add(rbtn_ans1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 162, -1, -1));

        rbtn_ans2.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans2.setText("Archaeikum-Mesozoikum-Neozoikum-Paleozoikum");
        rbtn_ans2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbtn_ans2ActionPerformed(evt);
            }
        });
        pnl_q1.add(rbtn_ans2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 188, -1, -1));

        rbtn_ans3.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans3.setText("Paleozoikum-Neozoikum-Mesozoikum-Archaeikum");
        rbtn_ans3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbtn_ans3ActionPerformed(evt);
            }
        });
        pnl_q1.add(rbtn_ans3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 214, -1, -1));
        ...
        jTextArea1.setText("Berdasarkan cabang ilmu geologi, zaman pra aksara di\nkelompokkan ke dalam 4 zaman kehidupan. Dibawah ini\nurutan 4 zaman pra aksara tersebut yang tepat adalah...");
        jScrollPane2.setViewportView(jTextArea1);

        pnl_q1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 78, 379, 70));

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Asus\\Documents\\NetBeansProjects\\JavaQuiz\\src\\javaquiz\\image\\bg_L2.jpeg")); // NOI18N
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
        ...
        new L2_Question3(correct).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans1.isSelected()) {
        new L2_Question3(correct).setVisible(true);
        this.dispose();}
    ...
    private void rbtn_ans3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtn_ans3ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rbtn_ans3ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L2_Question2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L2_Question2(0).setVisible(true);
            }
        });
    }
