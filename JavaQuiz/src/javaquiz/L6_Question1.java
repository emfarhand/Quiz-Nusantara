 ...
 * @author Asus
 */
public class L6_Question1 extends javax.swing.JFrame {
    int correct=0 ;
    /**
    ...
    private void initComponents() {
        ...
        rbtn_ans1.setText("mencari dan mendapatkan daerah penanaman modal");
        rbtn_ans1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbtn_ans1ActionPerformed(evt);
            }
        });
        pnl_q1.add(rbtn_ans1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 146, 373, -1));

        buttonGroup1.add(rbtn_ans2);
        rbtn_ans2.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans2.setText("mendapatkan nama baik dan kejayaan bangsa");
        pnl_q1.add(rbtn_ans2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 199, 373, -1));

        buttonGroup1.add(rbtn_ans3);
        rbtn_ans3.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans3.setText("mencari dan mendapatkan logam mulia atau kekayaan");
        pnl_q1.add(rbtn_ans3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 172, 373, -1));

        buttonGroup1.add(rbtn_ans4);
        rbtn_ans4.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans4.setText("mencapai tujuan suci untuk menyebarkan agama Nasrani");
        pnl_q1.add(rbtn_ans4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 225, -1, -1));
        ...
        pnl_q1.add(btn_next, new org.netbeans.lib.awtextra.AbsoluteConstraints(333, 266, -1, -1));
        ...
        jTextArea1.setText("Berikut ini yang merupakan tujuan yang hendak dicapai \noleh imperialisme modern adalah …");
        jScrollPane1.setViewportView(jTextArea1);

        pnl_q1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 83, 382, 49));
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
        ...
        new L6_Question2(correct).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans1.isSelected()) {
        new L6_Question2(correct).setVisible(true);
        this.dispose();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L6_Question1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L6_Question1().setVisible(true);
            }
        });
    }
