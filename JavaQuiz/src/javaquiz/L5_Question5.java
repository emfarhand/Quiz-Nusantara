 ...
 * @author Asus
 */
public class L5_Question5 extends javax.swing.JFrame {
    int correct=0 ;
    /**
     * Creates new form Question1
     */
    public L5_Question5(int correct) {
        initComponents();
    ...
    private void initComponents() {
        ...
        rbtn_ans1.setText("655 M");
        rbtn_ans1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbtn_ans1ActionPerformed(evt);
            }
        });
        pnl_q1.add(rbtn_ans1, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 177, -1, -1));

        buttonGroup1.add(rbtn_ans2);
        rbtn_ans2.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans2.setText("1537 M");
        pnl_q1.add(rbtn_ans2, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 218, -1, -1));

        buttonGroup1.add(rbtn_ans3);
        rbtn_ans3.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans3.setText("1059 M");
        pnl_q1.add(rbtn_ans3, new org.netbeans.lib.awtextra.AbsoluteConstraints(226, 177, -1, -1));

        buttonGroup1.add(rbtn_ans4);
        rbtn_ans4.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans4.setText("1157 M");
        pnl_q1.add(rbtn_ans4, new org.netbeans.lib.awtextra.AbsoluteConstraints(226, 218, -1, -1));
        ...
        pnl_q1.add(btn_next, new org.netbeans.lib.awtextra.AbsoluteConstraints(302, 264, -1, -1));
        ...
        jTextArea1.setText("Islam masuk pertama kali ke Nusantara pada Tahun ...");
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
       if(!rbtn_ans1.isSelected() && !rbtn_ans3.isSelected() && !rbtn_ans2.isSelected() && !rbtn_ans4.isSelected()){
        ...
        new Result(correct,5).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans1.isSelected()) {
        new Result(correct,5).setVisible(true);
        this.dispose();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L5_Question5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L5_Question5(0).setVisible(true);
            }
        });
    }
