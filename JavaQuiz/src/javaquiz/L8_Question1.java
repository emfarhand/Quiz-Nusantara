 ...
 * @author Asus
 */
public class L8_Question1 extends javax.swing.JFrame {
    int correct=0 ;
    /**
    ...
    private void initComponents() {
        ...
        rbtn_ans1.setText("Letkol Ventje Sumual.");
        rbtn_ans1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbtn_ans1ActionPerformed(evt);
            }
        });
        pnl_q1.add(rbtn_ans1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 184, -1, -1));

        buttonGroup1.add(rbtn_ans2);
        rbtn_ans2.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans2.setText("Radjiman Widio diningrat");
        pnl_q1.add(rbtn_ans2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 225, -1, -1));

        buttonGroup1.add(rbtn_ans3);
        rbtn_ans3.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans3.setText("Soeparpto");
        pnl_q1.add(rbtn_ans3, new org.netbeans.lib.awtextra.AbsoluteConstraints(228, 184, -1, -1));

        buttonGroup1.add(rbtn_ans4);
        rbtn_ans4.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans4.setText("Letkol Ahmad Husein");
        pnl_q1.add(rbtn_ans4, new org.netbeans.lib.awtextra.AbsoluteConstraints(228, 225, -1, -1));
        ...
        jTextArea1.setText("Siapakah pemimpin gerakan yang bertujuan untuk melawan\npemerintah pusat dan menentang tentara sehingga harus \nditumpas dan untuk menumpas gerakan Permesta ini, pe-\nmerintah harus melakuakan operasi militer beberapa kali ?");
        jScrollPane1.setViewportView(jTextArea1);

        pnl_q1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 83, 380, 91));
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
        ...
        new L8_Question2(correct).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans1.isSelected()) {
        new L8_Question2(correct).setVisible(true);
        this.dispose();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L8_Question1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L8_Question1().setVisible(true);
            }
        });
    }
