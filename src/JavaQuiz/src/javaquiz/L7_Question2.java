 ...
 * @author Asus
 */
public class L7_Question2 extends javax.swing.JFrame {
    int correct=0 ;
    /**
     * Creates new form Question1
     */
    public L7_Question2(int correct) {
        initComponents();
    ...
    private void initComponents() {
        ...
        pnl_q1.add(btn_next, new org.netbeans.lib.awtextra.AbsoluteConstraints(314, 267, -1, -1));
        ...
        jTextArea1.setText("Badan Penyelidik Usaha-usaha Persiapan Kemerdekaan \nIndonesia adalah sebuah badan yang dibentuk oleh pem-\nerintah pendudukan balatentara Jepang. Organisasi ini \ndikenal dengan nama...");
        jScrollPane1.setViewportView(jTextArea1);

        pnl_q1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 83, 379, 87));
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
        ...
        new L7_Question3(correct).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans1.isSelected()) {
        new L7_Question3(correct).setVisible(true);
        this.dispose();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L7_Question2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L7_Question2(0).setVisible(true);
            }
        });
    }
