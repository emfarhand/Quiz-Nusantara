 ...
 * @author Asus
 */
public class L2_Question1 extends javax.swing.JFrame {
    int correct=0 ;
    /**
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Zaman praaksara adalah zaman dimana pada saat itu \nmanusia manusia belum mengenal aksara (huruf), tulisan \nataupun sejenisnya. Zaman pra aksara juga di kenal den\ngan zaman...");
        jScrollPane1.setViewportView(jTextArea1);

        pnl_q1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 83, 376, 80));
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
        ...
        new L2_Question2(correct).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans4.isSelected()) {
        new L2_Question2(correct).setVisible(true);
        this.dispose();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L2_Question1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L2_Question1().setVisible(true);
            }
        });
    }
