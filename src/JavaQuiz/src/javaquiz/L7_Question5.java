 ...
 * @author Asus
 */
public class L7_Question5 extends javax.swing.JFrame {
    int correct=0 ;
    /**
     * Creates new form Question1
     */
    public L7_Question5(int correct) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("I Gusti Ketut Pudja menjadi Gubenur Provinsi ?");
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
       if(!rbtn_ans1.isSelected() && !rbtn_ans3.isSelected() && !rbtn_ans2.isSelected() && !rbtn_ans4.isSelected()){
        ...
        new Result(correct,7).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans1.isSelected()) {
        new Result(correct,7).setVisible(true);
        this.dispose();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L7_Question5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L7_Question5(0).setVisible(true);
            }
        });
    }
