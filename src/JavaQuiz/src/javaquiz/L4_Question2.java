 ...
 * @author Asus
 */
public class L4_Question2 extends javax.swing.JFrame {
    int correct=0 ;
    /**
     * Creates new form Question1
     */
    public L4_Question2(int correct) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lbl_title.setText("LEVEL 4 : Kerajaan Bercorak Buddha");
        ...
        jTextArea1.setText("Kerajaan Dharmasraya berganti nama menjadi ... setelah\nruntuh pada 1347 M tepatnya pada masa pemerintahan \nAdityawarman.");
        jScrollPane1.setViewportView(jTextArea1);

        pnl_q1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 78, 376, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Asus\\Documents\\NetBeansProjects\\JavaQuiz\\src\\javaquiz\\image\\bg_L4.jpg")); // NOI18N
        pnl_q1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 300));
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
        ...
        new L4_Question3(correct).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans2.isSelected()) {
        new L4_Question3(correct).setVisible(true);
        this.dispose();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L4_Question2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L4_Question2(0).setVisible(true);
            }
        });
    }
