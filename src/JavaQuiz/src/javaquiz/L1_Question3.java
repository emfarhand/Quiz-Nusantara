 ...
 * @author Asus
 */
public class L1_Question3 extends javax.swing.JFrame {
    int correct=0 ;
    /**
     * Creates new form Question1
     */
    public L1_Question3(int correct) {
        initComponents();
    ...
    private void initComponents() {
        ...
        rbtn_ans1.setText("Tari Jaipong");
        ...
        rbtn_ans3.setText("Tari Kecak");
        pnl_q1.add(rbtn_ans3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 190, -1, -1));

        buttonGroup1.add(rbtn_ans4);
        rbtn_ans4.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans4.setText("Tari Piring");
        pnl_q1.add(rbtn_ans4, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 230, -1, -1));
        ...
        jTextArea1.setText("Suatu tarian yang dipentaskan dalam kelompok yang mem\nbentuk lingkaran dan tari ini dipentaskan bersama dalam \ndrama Ramayanan. Biasanya para penari berdecak dan me\nngeluarkan suara \"cak-cak-cak\". Tari yang dimaksud ada\nlah...");
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
       if(!rbtn_ans1.isSelected() && !rbtn_ans3.isSelected() && !rbtn_ans2.isSelected() && !rbtn_ans4.isSelected()){
        ...
        new L1_Question4(correct).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans3.isSelected()) {
        new L1_Question4(correct).setVisible(true);
        this.dispose();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L1_Question3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L1_Question3(0).setVisible(true);
            }
        });
    }
