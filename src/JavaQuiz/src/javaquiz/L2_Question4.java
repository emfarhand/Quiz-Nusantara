 ...
 * @author Asus
 */
public class L2_Question4 extends javax.swing.JFrame {
    int correct=0 ;
    /**
     * Creates new form Question1
     */
    public L2_Question4(int correct) {
        initComponents();
    ...
    private void initComponents() {
        ...
        pnl_q1.add(btn_next, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 260, -1, -1));
        ...
        jTextArea1.setText("..... merupakan salah satu peralatan yang digunakan oleh\nmanusia untuk berburu pada masa pra aksara berburu dan\nmeramu. Fungsi dari alat ini adalah untuk menguliti hewan\nhasil buruan, merimbas kayu dan memecah tulang.");
        jScrollPane1.setViewportView(jTextArea1);

        pnl_q1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 78, 376, 90));
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
        ...
        }else if(rbtn_ans2.isSelected()){
        correct++;
        
        new L2_Question5(correct).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans2.isSelected()) { 
        new L2_Question5(correct).setVisible(true);
        this.dispose();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L2_Question4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L2_Question4(0).setVisible(true);
            }
        });
    }
