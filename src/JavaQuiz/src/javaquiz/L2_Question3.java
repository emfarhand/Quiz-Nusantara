 ...
 * @author Asus
 */
public class L2_Question3 extends javax.swing.JFrame {
    int correct=0 ;
    /**
     * Creates new form Question1
     */
    public L2_Question3(int correct) {
        initComponents();
    ...
    private void initComponents() {
        ...
        pnl_titleLayout.setHorizontalGroup(
            ...
            .addGroup(pnl_titleLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lbl_title, javax.swing.GroupLayout.PREFERRED_SIZE, 389, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnl_q1.add(btn_next, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 266, -1, -1));
        ...
        jTextArea1.setText("Masa berburu dan meramu adalah masa ketika manusia\npurba untuk mendapatkan makanan dengan cara berburu \ndan mengumpulkan makanan yang tersedia dari alam.\nPada masa ini manusia hidup secara nomaden, artinya...");
        jScrollPane1.setViewportView(jTextArea1);

        pnl_q1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 78, 369, -1));
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
       if(!rbtn_ans1.isSelected() && !rbtn_ans3.isSelected() && !rbtn_ans2.isSelected() && !rbtn_ans4.isSelected()){
        ...
        new L2_Question4(correct).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans4.isSelected()) {
        new L2_Question4(correct).setVisible(true);
        this.dispose();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L2_Question3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L2_Question3(0).setVisible(true);
            }
        });
    }
