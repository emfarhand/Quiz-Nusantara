 ...
 * @author Asus
 */
public class L3_Question2 extends javax.swing.JFrame {
    int correct=0 ;
    /**
     * Creates new form Question1
     */
    public L3_Question2(int correct) {
        initComponents();
    ...
    private void initComponents() {
        ...
        pnl_q1.add(pnl_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        lbl_q1.setBackground(null);
        ...
        rbtn_ans3.setText("Prasasti Pasir Awi");
        pnl_q1.add(rbtn_ans3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 180, -1, -1));

        buttonGroup1.add(rbtn_ans4);
        rbtn_ans4.setFont(new java.awt.Font("Futura Md BT", 1, 12)); // NOI18N
        rbtn_ans4.setText("Prasasti Canggal");
        rbtn_ans4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbtn_ans4ActionPerformed(evt);
            }
        });
        pnl_q1.add(rbtn_ans4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 220, -1, -1));
        ...
        jTextArea1.setText("Berikut ini prasasti-prasasti peninggalan Kerajaan \nTarumanegara antara lain, kecuali...");
        jScrollPane1.setViewportView(jTextArea1);

        pnl_q1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 78, 374, -1));
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
        ...
        new L3_Question3(correct).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans4.isSelected()) {
        new L3_Question3(correct).setVisible(true);
        this.dispose();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L3_Question2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L3_Question2(0).setVisible(true);
            }
        });
    }
