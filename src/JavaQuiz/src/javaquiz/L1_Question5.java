 ...
 * @author Asus
 */
public class L1_Question5 extends javax.swing.JFrame {
    int correct=0 ;
    /**
     * Creates new form Question1
     */
    public L1_Question5(int correct) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Ibu kota provinsi Kalimantan Tengah adalah...");
        jScrollPane1.setViewportView(jTextArea1);

        pnl_q1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 78, 379, 50));
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
       if(!rbtn_ans1.isSelected() && !rbtn_ans3.isSelected() && !rbtn_ans2.isSelected() && !rbtn_ans4.isSelected()){
        ...
        correct++;
        new Result(correct,1).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans3.isSelected()) {
        new Result(correct,1).setVisible(true);
        this.dispose();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L1_Question5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L1_Question5(0).setVisible(true);
            }
        });
    }
