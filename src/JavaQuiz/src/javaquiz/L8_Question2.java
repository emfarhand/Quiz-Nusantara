 ...
 * @author Asus
 */
public class L8_Question2 extends javax.swing.JFrame {
    int correct=0 ;
    /**
     * Creates new form Question1
     */
    public L8_Question2(int correct) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lbl_title.setText("LEVEL 8 : Aksi Pasca Kemerdekaan NKRI");
        ...
        pnl_q1.add(btn_next, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 270, -1, -1));
        ...
        jTextArea1.setText("Pemberontakan ini berasal dari protes masyarakat daerah \nyang merasakan ketidakadilan pemerintah pusat. Daerah \nkecewa terhadap pemerintah pusat yang dianggap tidak \nadil dalam alokasi danapembangunan. Kekecewaan terse-\nbut diwujudkan dengan pembentukan dewan-dewan da-\nerah seperti Dewan Manguni di Sulawesi Utara yang \ndipimpin oleh Kolonel Ventje Sumual. Nama pemberontakan\nini disebut...");
        jScrollPane1.setViewportView(jTextArea1);

        pnl_q1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 78, 380, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Asus\\Documents\\NetBeansProjects\\JavaQuiz\\src\\javaquiz\\image\\bg_L8.jpg")); // NOI18N
    ...
    private void btn_nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nextActionPerformed
        ...
        new L8_Question3(correct).setVisible(true);
        this.dispose();
       }else if(!rbtn_ans1.isSelected()) {
        new L8_Question3(correct).setVisible(true);
        this.dispose();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L8_Question2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L8_Question2(0).setVisible(true);
            }
        });
    }
